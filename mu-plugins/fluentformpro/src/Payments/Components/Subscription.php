...
class Subscription extends BaseFieldManager
{
    ...
    function getComponent()
    {
        return array(
            ...
            'settings'       => array(
                'container_class'      => '',
                'label'                => __('Subscription Item', 'fluentformpro'),
                'admin_field_label'    => '',
                'label_placement'      => '',
                'display_type'         => '',
                'help_message'         => '',
                ...
                'subscription_options' => [
                    [
                        ...
                        "has_trial_days"      => "no",
                        "is_default"          => "yes",
                        "name"                => __("Monthly Plan", 'fluentformpro'),
                        "plan_features"       => [],
                        "signup_fee"          => 0,
            ...
            'editor_options' => array(
                'title'      => __('Subscription', 'fluentformpro'),
    ...
    public function renderMultiProduct($data, $form)
    {
        ...
        if ($type === 'select') {
            ...
            $placeholder = ArrayHelper::get($data, 'settings.placeholder', __('--Select Plan--', 'fluentformpro'));
    ...
    private function makeCustomInputHtml($field, $plan, $parentInputType, $markup)
    {
        ...
        $customAmountInputAttributes = $this->buildAttributes([
            'name'                   => $htmlID,
            'type'                   => 'number',
            'value'                  => ArrayHelper::get($plan, 'user_input_default_value', 0),
            'min'                    => ArrayHelper::get($plan, 'user_input_min_value', 0),
            'step'                   => 'any',
