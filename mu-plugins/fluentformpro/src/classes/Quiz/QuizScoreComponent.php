...
class QuizScoreComponent extends BaseFieldManager
{
    ...
    public function getEditorCustomizationSettings()
    {
        return [
            ...
            'quiz_info' => [
                'template' => 'infoBlock',
                'text'     => '<h6>Personality Quiz Instruction</h6> <span>Personality will be determined based on most answered option. The quiz answers and personality option value must match, so please add your answers value accordingly.</span></br> ',
                'dependency' => [
                    'depends_on' => 'settings/result_type',
                    'value'      => 'personality',
                    'operator'   => '==',
