...
class Bootstrap extends IntegrationManager
{
    public function __construct(Application $app)
    {
        ...
        $this->description = 'Capture Fluent Forms Submission to your Notion workspaces — and do it exactly the way you want';
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!is_wp_error($response)) {
            do_action('fluentform/integration_action_result', $feed, 'success',
                'Notion feed has been successfully initialed and pushed data');
        } else {
