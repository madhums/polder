 ...
 * @return bool
 */
function acf_engine_class_exists( $class_name, $ucwords = true ) {
	$class_name = acf_engine_copy_postmeta( $class_name );

	if ( $ucwords ) {
		return class_exists( ucwords( $class_name ) );
	}

	return call_user_func( $class_name );
}
